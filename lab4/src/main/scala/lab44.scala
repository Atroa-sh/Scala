...
//granica nie jest jednoznaczna, czasem dla 15849 miescilo sie, innymi razami wyrzucało StackOverflowError.
//podobne zjawiso zachodzilo dla tablic nawet o 10 komorek krotszych
// Oczywiście by znalesc granice uzyto wyszukiwania binarnego